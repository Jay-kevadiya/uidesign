...
export default RightCategory = (props) => {
    return (
                    ...
                    <View style={styles.leftWrapper}>
                        <View style={styles.rightWrapper}>
                            <View style={styles.itemWrapper}>
                                <View style={styles.itemStyle}>
                                    <TouchableOpacity onPress={() => alert('sh')}>
                                        <Text style={styles.textdecor}>Shirt</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={() => alert('Sweater')}>
                                        <Text style={styles.textdecor}>T-shirt</Text>
                                    </TouchableOpacity>
                            ...
                            <View style={styles.itemWrapper}>
                                <View style={styles.itemStyle}>
                                    <TouchableOpacity onPress={() => alert('sh')}>
                                        <Text style={styles.textdecor}>Watch</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={() => alert('Sweater')}>
                                        <Text style={styles.textdecor}>Bags</Text>
                                    </TouchableOpacity>
